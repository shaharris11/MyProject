        ...
        <>
            <body id="homePage">
                <div className="home">
                    ...
                    <div id="linkdiv">
                        <p>To see or read more about my life in the other world, click on the links below:</p>
                        <a href="https://www.crunchyroll.com/series/GYZJ43JMR/that-time-i-got-reincarnated-as-a-slime??utm_campaign=media_actions&utm_medium=deep_link&utm_source=google" id="link">Anime Link</a>
                        <br />
                        <a href="https://w1.tenseislime.com/" id="link">Manga Link</a>
                    </div>
                </div>
            </body>
        </>
